...
public class KThread {
	...
	public static void finish() {
		...
		if(currentThread.waiting != null){
			currentThread.waiting.ready();	
		}
	...
	private static void joinTest3(){
		...
		KThread[] kid = new KThread[10];

		int i;
		for(i = 0; i < 10; i++){

			kid[i] = new KThread(new JoinTester(i));
			kid[i].setName("t#: " + i);
			//kid[i].fork();
		}
		for(i = 0; i < 10; i++){
	...
	private static class JoinTester implements Runnable {
		JoinTester(int which){
			this.which = which;
		}
		
		public void run() {

			System.out.println("Child #" + which + " running.");
			//TODO put a sleep here
			
			System.out.println("Child #" + which + " halting.");
			finish();
		}
	...
	private static void joinTest4(){
		...
		KThread child = new KThread(new MoreTestin(1));
		child.setName("joinTest4 Child");
		child.fork();
		for(int i = 0; i < 5; i++){
	...
	private static class MoreTestin implements Runnable {
		MoreTestin(int which){
			this.which = which;
		}
